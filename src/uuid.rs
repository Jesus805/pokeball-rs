...
pub const CENTRAL_TO_PERIPHERAL_CHAR_UUID: Uuid =
    Uuid::from_bytes(crate::constants::CENTRAL_TO_PERIPHERAL_CHAR_BYTES);
pub const PERIPHERAL_COMMANDS_CHAR_UUID: Uuid =
    Uuid::from_bytes(crate::constants::PERIPHERAL_COMMANDS_CHAR_BYTES);
pub const PERIPHERAL_TO_CENTRAL_CHAR_UUID: Uuid =
    Uuid::from_bytes(crate::constants::PERIPHERAL_TO_CENTRAL_CHAR_BYTES);
