...
pub const CERT_STATE_1_NOTIFY_DATA: [u8; 4] = [0x02, 0x00, 0x00, 0x00];

pub const CERT_STATE_2_NOTIFY_DATA: [u8; 4] = [0x04, 0x00, 0x23, 0x00];

pub const CERT_STATE_3_NOTIFY_DATA: [u8; 4] = [0x04, 0x00, 0x01, 0x00];

pub const CERT_STATE_4_NOTIFY_DATA: [u8; 4] = [0x05, 0x00, 0x00, 0x00];

pub const CERT_STATE_5_NOTIFY_DATA: [u8; 4] = [0x04, 0x00, 0x02, 0x00];

pub const BUTTON_PUSH: [u8; 2] = [0x03, 0xff];
